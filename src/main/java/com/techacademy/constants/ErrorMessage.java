...
public class ErrorMessage {
    ...
    private final static Map<ErrorKinds, List<String>> errorMessageMap = new HashMap<ErrorKinds, List<String>>() {
...

        {
            ...
            // パスワード以外の空白チェック用エラーメッセージ
            put(ErrorKinds.BLANK_ERROR2, new ArrayList<String>(Arrays.asList("blankError", "値を入力してください")));
            ...
            // 100文字以下チェック用エラーメッセージ
            put(ErrorKinds.ONE_CHECK_ERROR,
                    new ArrayList<String>(Arrays.asList("100checkError", "100文字以下で入力してください")));
            // 同一日付チェック用エラーメッセージ
            put(ErrorKinds.SIX_CHECK_ERROR,
                    new ArrayList<String>(Arrays.asList("600checkError", "600文字以下で入力してください")));
